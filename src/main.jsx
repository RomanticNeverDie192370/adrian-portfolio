...
function App() {
  ...
  return <main className="landing-page">
    ...
    <header className="glass-header">
      ...
      <a className="header-cta" href="mailto:hello@adrian.design">联系我 <ArrowUpRight size={15} /></a><button className="menu-button" aria-label="打开导航"><Menu size={20} /></button>
    </header>
    ...
    {page === 'experience' && <section className="work-page"><header className="work-hero"><p>01 — SELECTED WORK</p><h1>作品<br/><em>展示</em></h1><span>品牌视觉 / 电商设计 / AI 创意</span></header><div className="work-grid"><article className="work-card work-featured"><img src={asset('projects/car-light-store-cover.png')} alt="Performance automotive lighting independent store"/><div className="work-shade"/><div className="work-number">01</div><div className="work-info"><p>INDEPENDENT E-COMMERCE / 2026</p><h2>Performance<br/>Lighting Store</h2><span>独立站视觉、商品系统与完整购物体验</span></div></article><article className="work-card"><img src="https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?auto=format&fit=crop&w=1300&q=90" alt="Brand identity project"/><div className="work-shade"/><div className="work-number">02</div><div className="work-info"><p>Brand Identity / 2024</p><h2>Multi-store<br/>Brand Renewal</h2><span>品牌标识与主视觉系统</span></div></article><article className="work-card work-link" onClick={() => navigate('hakii')} role="button" tabIndex="0" onKeyDown={(event) => event.key === 'Enter' && navigate('hakii')}><img src={asset('projects/hakii-arctic-air-tech.jpg')} alt="HAKII Arctic Air Tech earbud visual project"/><div className="work-shade"/><div className="work-number">03</div><div className="work-info"><p>HAKII / 2024</p><h2>Arctic<br/>Air Tech</h2><span>耳机品牌视觉与电商详情页设计</span></div></article><a className="work-card work-link taihang-card" href="https://taihang-xu.yzy-192370.chatgpt.site" target="_blank" rel="noreferrer"><img src={asset('projects/taihang-xu-cover.jpg')} alt="太行序东方草本茶品牌视觉项目"/><div className="work-shade"/><div className="work-number">04 ↗</div><div className="work-info"><p>TAIHANG XU / 2026</p><svg className="taihang-project-logo" viewBox="160 365 1080 315" role="img" aria-label="太行序品牌标志"><image href={asset('projects/taihang-xu-logo.svg')} width="1400" height="1050" /></svg><span>点击进入品牌网站</span></div></a></div></section>}
